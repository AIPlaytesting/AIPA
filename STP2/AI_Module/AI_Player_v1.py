...
class AI_Player:
    ...
    def __init__(self, game_manager: game_manager.GameManager = None):
        self.LoadModel('14oct_save_model_test')
    ...
    def LoadModel(self, model_folder_name=''):
        ...
        if model_folder_name == '':
            model_folder_name = '14oct_save_model_test'

        model_path = 'Saved Models\\' + model_folder_name
